...
class InitSchema < ActiveRecord::Migration[7.0]
  def up
    ...
    create_table 'booking_approvals' do |t|
      ...
      t.index %w(user_id booking_id), name: 'index_booking_approvals_on_user_id_and_booking_id', unique: true
    ...
    create_table 'digital_codes' do |t|
      ...
      t.datetime 'created_at', null: false
      t.datetime 'updated_at', null: false
      t.index %w(name venue_id), name: 'index_digital_codes_on_name_and_venue_id', unique: true
    ...
    create_table 'family_links' do |t|
      ...
      t.datetime 'created_at', null: false
      t.datetime 'updated_at', null: false
      t.index %w(family_id user_id), name: 'index_family_links_on_family_id_and_user_id', unique: true
    ...
    create_table 'home_services' do |t|
      ...
      t.datetime 'created_at', null: false
      t.datetime 'updated_at', null: false
      t.index %w(name venue_id), name: 'index_home_services_on_name_and_venue_id', unique: true
    ...
    create_table 'keys' do |t|
      ...
      t.datetime 'created_at', null: false
      t.datetime 'updated_at', null: false
      t.index %w(name venue_id), name: 'index_keys_on_name_and_venue_id', unique: true
    ...
    create_table 'networks' do |t|
      ...
      t.datetime 'created_at', null: false
      t.datetime 'updated_at', null: false
      t.index %w(name venue_id), name: 'index_networks_on_name_and_venue_id', unique: true
    ...
    create_table 'school_holidays' do |t|
      ...
      t.datetime 'created_at', null: false
      t.datetime 'updated_at', null: false
      t.index %w(description zone school_year),
              name: 'index_school_holidays_on_description_and_zone_and_school_year', unique: true
    end
    ...
    create_table 'vehicles' do |t|
      ...
      t.datetime 'created_at', null: false
      t.datetime 'updated_at', null: false
      t.index %w(vehicle_type name venue_id), name: 'index_vehicles_on_vehicle_type_and_name_and_venue_id',
                                              unique: true
    ...
    create_table 'venues' do |t|
      ...
      t.index %w(name family_id), name: 'index_venues_on_name_and_family_id', unique: true
    end
